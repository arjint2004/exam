...
<div class="mainholder">
	...
	<div class="createnewdiv">
		<p class="pagetittle">Create user account</p>
	</div>
	<?php 
		if(isset($success))
	    ...
	    <tr>
	    <td><div class="label">Nama Blekang</div></td>
	    <td><div class="input">
	    ...
	    <td><div class="input"><input type="text" name="username" value="<?php if(isset($reset)) echo ($reset) ? "" : set_value('username'); ?>"  class="ui-corner-all input-text validate[required] minSize[3] maxSize[20]"><?=form_error('username'); ?></div></td>
	    </tr>
	    <tr>
